...
const AdminSavePatientMenu = ({ closeSavePatientMenuHandle, patientsData, setPatientsData }) => {
    ...
    const fields = {
        ...
        disease_data: { type: 'enum', options: ['Да', 'Нет'], translation: 'Стадия заболевания / Фиброз / Шкалы', data_type: 'str', default: 'Да', columns: ['Результат непрямой эластографии печени, стадия фиброза (kPa)', 'Результат непрямой эластографии селезенки (kPa)', 'Наличие ВРВ', "Красные знаки ВРВ", 'Наличие асцита', 'Тест связывания чисел А (в секундах)', 'Наличие ошибок', 'Тест связывания чисел B (в секундах)', 'Наличие ошибок ', 'Тест чисел и символов (количество верно заполненных ячеек)', 'Наличие ошибок  ', 'Серийный тест точек (в секундах)', 'Наличие ошибок   ', 'Тест линий (в секундах)', 'Количество касаний границы', 'Количество выходов за границы', 'Психометрический индекс ПЭ', 'Тип энцефалопатии', 'Степень энцефалопатии', 'Течение энцефалопатии', 'Наличие провоцирующих факторов'] },
