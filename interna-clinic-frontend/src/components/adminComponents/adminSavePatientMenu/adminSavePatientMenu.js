...
const AdminSavePatientMenu = ({ closeSavePatientMenuHandle, patientsData, setPatientsData }) => {
    ...
    const fields = {
        ...
        disease_data: { type: 'enum', options: ['Да', 'Нет'], translation: 'Стадия заболевания / Фиброз / Шкалы', data_type: 'str', default: 'Да', columns: ['Результат непрямой эластографии печени, стадия фиброза (kPa)', 'Результат непрямой эластографии селезенки (kPa)', 'Наличие ВРВ', "Красные знаки ВРВ", 'Наличие асцита', 'Тест связывания чисел А (в секундах)', 'Наличие ошибок', 'Тест связывания чисел B (в секундах)', 'Наличие ошибок ', 'Тест чисел и символов (в секундах)', 'Наличие ошибок  ', 'Серийный тест точек (в секундах)', 'Наличие ошибок   ', 'Тест линий (в секундах)', 'Наличие ошибок    ', 'Тип энцефалопатии', 'Степень энцефалопатии', 'Течение энцефалопатии', 'Наличие провоцирующих факторов'] },
    ...
    const translation = {
        ...
        symbol_test: 'Тест чисел и символов (в секундах)',
