...
class Patient(Base):
    ...
    line_test_number_of_border_touches = Column(Numeric(precision=5, scale=2), nullable=False, default=0.00, server_default='0.00')
    line_test_number_of_beyond_border = Column(Numeric(precision=5, scale=2), nullable=False, default=0.00, server_default='0.00')
    psychometric_index_PE = Column(Numeric(precision=5, scale=2), nullable=False, default=0.00, server_default='0.00')
